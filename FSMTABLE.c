...
static void bitSet(int a, MYPORT *p1);
static void bitClr(int b, MYPORT *p2);
static void bitToggle(int c, MYPORT *p3);
static unsigned int bitGet(int d, MYPORT *p4);
static void maskOn(char mask, MYPORT *p5);
static void maskOff(MYPORT *p6);
MYPORT backup;
...
STATE estado_menuA[]=
{
{'s',estado_menuABD,bitSet},
{'c',estado_menuABD,bitClr},
{'t',estado_menuABD,bitToggle},
{'g',estado_menuABD,bitGet},
{'n',estado_menuABD,maskOn},
{'f',estado_menuABD,maskOff},
...
{   
    ...
    //funcion para inicializar maquina de estado
    
    STATE *FSM_GetInitState(void)
{
 	return (estado_menuABD);
}
